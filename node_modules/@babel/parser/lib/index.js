        ...
        if (node.type === "ArrowFunctionExpression") {
          if (node.typeParameters || !node.returnType) {
            ...
            this.toAssignableList(
              ...
              (_node$extra = node.extra) === null || _node$extra === void 0
                ? void 0
      ...
      if (disallowInvalid) {
        for (let i = 0; i < arrows.length; i++) {
          ...
          this.toAssignableList(
            ...
            true,
            "arrow function parameters",
            (_node$extra2 = node.extra) === null || _node$extra2 === void 0
              ? void 0
      ...
      return partition(arrows, node => {
        try {
          ...
          this.toAssignableList(
            ...
            true,
            "arrow function parameters",
            (_node$extra3 = node.extra) === null || _node$extra3 === void 0
              ? void 0
  ...
  class extends superClass {
    ...
    parseMaybeAssign(...args) {
      ...
      if (this.match(types.jsxTagStart)) {
        ...
        assert(
          this.state.context[this.state.context.length - 2] === types$1.j_expr
        );
        const state = this.state.clone();
...
class LValParser extends NodeUtils {
  ...
  checkLVal(expr, bindingType = BIND_NONE, checkClashes, contextDescription) {
    switch (expr.type) {
      ...
      default: {
        const message =
          (bindingType === BIND_NONE ? "Invalid" : "Binding invalid") +
          " left-hand side" +
          (contextDescription ? " in " + contextDescription : "expression");
...
class ExpressionParser extends LValParser {
  ...
  parseAsyncArrowFromCallExpression(node, call) {
    ...
    this.parseArrowExpression(
      ...
      call.arguments,
      true,
      (_call$extra = call.extra) === null || _call$extra === void 0
        ? void 0
...
class StatementParser extends ExpressionParser {
  ...
  checkExport(node, checkNames, isDefault, isFrom) {
    if (checkNames) {
      if (isDefault) {
        ...
        for (
          let _i3 = 0, _node$specifiers = node.specifiers;
          _i3 < _node$specifiers.length;
          _i3++
        ) {
        ...
        if (
          ...
          for (
            let _i4 = 0, _node$declaration$dec = node.declaration.declarations;
            _i4 < _node$declaration$dec.length;
            _i4++
          ) {
  ...
  checkDeclaration(node) {
    if (node.type === "Identifier") {
      ...
      for (
        let _i5 = 0, _node$properties = node.properties;
        _i5 < _node$properties.length;
        _i5++
      ) {
      ...
      for (
        let _i6 = 0, _node$elements = node.elements;
        _i6 < _node$elements.length;
        _i6++
      ) {
