...
var _runtimeCorejs2Definitions = _interopRequireDefault(
  require("./runtime-corejs2-definitions")
);

var _runtimeCorejs3Definitions = _interopRequireDefault(
  require("./runtime-corejs3-definitions")
);
...
var _default = (0, _helperPluginUtils().declare)((api, options, dirname) => {
  ...
  const { BuiltIns, StaticProperties, InstanceProperties } = (injectCoreJS2
    ? _runtimeCorejs2Definitions.default
    : _runtimeCorejs3Definitions.default)(runtimeVersion);
        ...
        if (injectCoreJS3 && !hasStaticMapping(object.name, propertyName)) {
          if (
            ...
            if (_core().types.isIdentifier(object)) {
              ...
              context2 = _core().types.assignmentExpression(
                "=",
                context1,
                object
              );
