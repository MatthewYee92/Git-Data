...
var _corejs2BuiltIns = _interopRequireDefault(
...
const validIncludesAndExcludesWithCoreJS2 = new Set([
  ...allPluginsList,
  ...Object.keys(_corejs2BuiltIns.default),
  ..._getPlatformSpecificDefault.defaultWebIncludes
]);
const validIncludesAndExcludesWithCoreJS3 = new Set([
  ...allPluginsList,
  ...Object.keys(_data().default)
]);
...
function normalizeCoreJSOption(corejs, useBuiltIns) {
  ...
  const version = rawVersion
    ? (0, _semver().coerce)(String(rawVersion))
    : false;
