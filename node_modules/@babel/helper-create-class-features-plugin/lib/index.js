...
function _helperSplitExportDeclaration() {
  const data = _interopRequireDefault(
    require("@babel/helper-split-export-declaration")
  );
...
function createClassFeaturePlugin({ name, feature, loose, manipulateOptions }) {
  return {
    name,
    manipulateOptions,
    ...
    visitor: {
      Class(path, state) {
        ...
        for (const path of body.get("body")) {
          ...
          if (!isDecorated)
            isDecorated = (0, _decorators.hasOwnDecorators)(path.node);
        }
        ...
        if (isDecorated) {
          ...
          ({ staticNodes, instanceNodes, wrapClass } = (0,
